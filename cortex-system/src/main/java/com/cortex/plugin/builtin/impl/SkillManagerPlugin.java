...
import com.cortex.skill.util.SkillMetadataParser;
...
public class SkillManagerPlugin implements IBuiltinPlugin
{
    ...
    {
        List<Long> authorizedSkillIds = com.cortex.common.utils.spring.SpringUtils
                .getBean(com.cortex.agent.mapper.AiAgentSkillMapper.class)
