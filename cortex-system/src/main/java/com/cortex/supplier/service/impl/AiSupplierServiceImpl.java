...
import com.cortex.supplier.mapper.AiSupplierMapper;
...
public class AiSupplierServiceImpl implements IAiSupplierService 
{
    ...
    private String getTestModel(Long supplierId)
    {
        ...
        List<com.cortex.supplier.domain.AiModel> models = aiModelMapper.selectAiModelListBySupplierId(supplierId);
        ...
        return models.stream()
            ...
            .map(com.cortex.supplier.domain.AiModel::getModelCode)
            .findFirst()
            .orElse(null);
    }
