...
import com.cortex.knowledge.rag.MilvusStoreManager;
import com.cortex.knowledge.service.IAiKnowledgeBaseService;
...
public class AiKnowledgeBaseServiceImpl implements IAiKnowledgeBaseService
{
    ...
    {
        // 自动生成collection名
        aiKnowledgeBase.setCollectionName("cortex_kb_" + System.currentTimeMillis());
