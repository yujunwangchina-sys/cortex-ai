...
public class AgentConfigLoader
{
    ...
    @Autowired
    private com.cortex.agent.mapper.AiAgentMapper agentMapper;

    @Autowired
    private com.cortex.agent.mapper.AiAgentSkillMapper agentSkillMapper;

    @Autowired
    private com.cortex.agent.mapper.AiAgentPluginMapper agentPluginMapper;

    @Autowired
    private com.cortex.skill.mapper.SkillNodeMapper skillNodeMapper;

    @Autowired
    private com.cortex.plugin.mapper.AiPluginMapper pluginMapper;

    @Autowired
    private com.cortex.plugin.mapper.AiPluginToolMapper pluginToolMapper;

    @Autowired
    private com.cortex.knowledge.mapper.AiAgentKnowledgeMapper agentKbMapper;
    private com.cortex.agent.mapper.AiAgentDelegationMapper delegationMapper;
     ...
     */
    public java.util.List<com.cortex.knowledge.domain.AiAgentKnowledge> loadKnowledgeBases(Long agentId)
    {
        try
        {
