package com.cortex.common.utils.file;
...
import com.cortex.common.exception.file.FileNameLengthLimitExceededException;
import com.cortex.common.exception.file.FileSizeLimitExceededException;
import com.cortex.common.exception.file.InvalidExtensionException;
...
import com.cortex.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = CortexConfig.getProfile();
    ...
    {
        int dirLastIndex = CortexConfig.getProfile().length() + 1;
