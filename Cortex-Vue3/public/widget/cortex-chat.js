...
(function (global) {
  ...
  function createWidget() {
    ...
    panel.innerHTML =
      '<div class="cortex-header">' +
        ...
        '<div class="cortex-header-actions">' +
          '<button class="cortex-header-btn" id="cortex-new-session" title="新建会话">+</button>' +
    ...
    shadow.getElementById('cortex-new-session').onclick = newSession;
  ...
  function newSession() {
    ...
    if (iframe && iframe.contentWindow) {
      iframe.contentWindow.postMessage({
        type: 'cortex-new-session'
      }, '*');
      console.log('📤 发送新建会话消息到 iframe');
    }
  }
