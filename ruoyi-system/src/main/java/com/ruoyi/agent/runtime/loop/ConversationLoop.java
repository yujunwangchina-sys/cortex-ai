...
import com.ruoyi.agent.mapper.AiAgentExecutionLogMapper;
import com.ruoyi.agent.runtime.context.AgentSessionContext;
import com.ruoyi.agent.runtime.llm.ErrorClassifier;
...
import com.ruoyi.agent.runtime.model.ToolCallResult;
import com.ruoyi.agent.runtime.prompt.AgentConfigLoader;
import com.ruoyi.plugin.builtin.impl.SubAgentPlugin;
import com.ruoyi.agent.runtime.tool.ToolExecutor;
...
public class ConversationLoop {
    ...
    public String run(AgentSessionContext ctx, String userMessage,
                      ...
                      com.ruoyi.agent.domain.AiAgent agent,
                      List<com.ruoyi.skill.domain.SkillNode> skills,
        ...
        if (request.getFileIds() != null && !request.getFileIds().isEmpty()) {
            ...
            for (Long fileId : request.getFileIds()) {
                // 从文件服务查询文件名
                try {
                    com.ruoyi.agent.domain.AiAgentFile file = com.ruoyi.common.utils.spring.SpringUtils
                        .getBean(com.ruoyi.agent.service.IAiAgentFileService.class)
