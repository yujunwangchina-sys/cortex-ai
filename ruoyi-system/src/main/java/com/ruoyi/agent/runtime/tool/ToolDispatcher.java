package com.ruoyi.agent.runtime.tool;

import com.ruoyi.agent.runtime.context.RuntimeContext;
import com.ruoyi.agent.runtime.context.RuntimeContextHolder;
...
public class ToolDispatcher
{
    ...
    @Autowired
    private com.ruoyi.plugin.mapper.AiPluginExecutionLogMapper executionLogMapper;
                           ...
                           String toolCallId, String arguments)
    {
        ...
        // 创建执行日志对象
        com.ruoyi.plugin.domain.AiPluginExecutionLog executionLog = new com.ruoyi.plugin.domain.AiPluginExecutionLog();
        ...
        // 尝试获取用户ID
        try {
            executionLog.setUserId(com.ruoyi.common.utils.SecurityUtils.getUserId());
        } catch (Exception e) {
            // 获取用户ID失败时忽略
        }
     ...
     * 异步记录执行日志
     */
    private void recordLog(com.ruoyi.plugin.domain.AiPluginExecutionLog logEntry) {
        try {
